...
public class CancelOrderMail implements Runnable{
	...
	public String publishSendingToUser() {
		text = "Dear Admin (XYZ) ,\n\n Order Cancelled for "+custName+" ! \n\n Please open the attachment to view the cancelled order "
				+ "\n\n Delivery Date was: "+delivDate+" \n\n Delivery Time was: "+delivTime+" Hrs.";
		...
		try {
			...
			message.setSubject("[ REVISED ORDER "+revNo+" ] [ DELIVERY DATE AND TIME : "+delivDate+" "+delivTime+" Hrs.] - "+subject+custName);
				...
				message.setSubject("[ ORDER CANCELLED ]  - "+subject+custName);
			}
		    ...
		    String filename = "/var/vegkart/OrderToXYZ.xlsx";//change accordingly  
